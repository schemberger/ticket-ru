...
@section('venda')
    ...
    {!! Form::open(array('url' => 'categoria/'.$restaurante->cd_unidade.'/storeCusto', 'class'=>'form-horizontal')) !!}
        ...
        <form class="form-horizontal"style="margin-top: 50px;">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="campoData" name="dt_ini_vigencia" placeholder="Data Início Vigência" class="form-control input-md"
                               type="text">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="currency" name="vl_categoria" placeholder="Valor da categoria" class="form-control input-md"
                               type="text">
                    </div>
                </div>
